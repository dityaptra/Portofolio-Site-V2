        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold text-slate-800 dark:text-white mb-6 leading-tight">
              Ingin Berdiskusi <br />
              <span className="text-emerald-600 dark:text-emerald-400">Proyek Menarik?</span>
            </h2>
            <p className="text-lg text-slate-600 dark:text-slate-400 mb-8 max-w-md">
              ...
              pengembangan kecerdasan buatan, atau sekadar peluang kemitraan. Mari diskusikan solusi terbaik untuk kebutuhan Anda.
            </p>
