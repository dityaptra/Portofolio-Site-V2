...
export default function Certifications() {
  return (
    <section id="certifications" className="py-20 bg-slate-50 dark:bg-slate-900 transition-colors duration-300">
            ...
            >
              ...
              <div className="h-full bg-white dark:bg-slate-800 rounded-2xl p-6 shadow-sm border border-slate-200 dark:border-slate-700 transition-all duration-300 hover:shadow-xl hover:-translate-y-2 hover:border-emerald-500/50 relative overflow-hidden flex flex-col">
                ...
                <div className="mb-6 relative z-10 grow">
                  <h3 className="text-xl font-bold text-slate-800 dark:text-white mb-2 line-clamp-2 group-hover:text-emerald-600 dark:group-hover:text-emerald-400 transition-colors">
                    {cert.title}
                  </h3>
                ...
                <div className="relative z-10 flex justify-end mt-auto pt-4 border-t border-slate-100 dark:border-slate-700">
                  <a
                    href={cert.link}
                    target="_blank"
